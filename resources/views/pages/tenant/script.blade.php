<script>
     ...
     $("[name=form_data]").on('submit', function(e) {
          ...
          if(save_method == 'add'){
               var url = '{{route("master.tenant.simpan")}}';
          }else{
               var url = '{{route("master.tenant.ubah")}}';
          }
     ...
     function ubah(id)
     {
          ...
          $.ajax({
               ...
               success: function(data){
                    ...
                    $('[name="category_id"]').val(data.category_id).change();
               },
     ...
     function hapus(id)
     {
          Swal.fire({
               ...
               if (result.value) {
                    $.ajax({
                         url : "{{url('master/tenant/hapus/')}}"+"/"+id,
                         type: "POST",
                         data : {
                              '_method'   : 'delete',
                              '_token'    : '{{ csrf_token() }}',
